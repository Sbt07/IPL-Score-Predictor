...
batting_team= st.selectbox('Select the Batting Team ',('Royal Challengers Bangalore', 'Delhi Daredevils', 'Kings XI Punjab','Kolkata Knight Riders','Chennai Super Kings','Rajasthan Royals','Mumbai Indians','Sunrisers Hyderabad'))
